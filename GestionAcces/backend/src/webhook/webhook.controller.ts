...
export class WebHookController {
    ...
    async create(@Param('topic') topic, @Body() payload: any) {
        ...
        if (this.isCredentialIssuance(topic) && this.isVirtualAccessRights(payload)) {
    ...
    private isVirtualAccessRights(payload: any): boolean {
        return payload.credential_proposal_dict.schema_name === 'CQEN_Droit_Acces_Virtuel';
    }
    ...
    private buildAttestationEmise(payload: any): AttestationEmise {
        ...
        attestationEmise.threadId = payload.threadId;
